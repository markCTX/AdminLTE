...
Together with a token it is also possible to [enable and disable (also with a set timeout) blocking via the API](https://discourse.x-filter.net/t/is-there-an-api-command-to-disable-ad-blocking/7693).
