...
*  Please see LICENSE file for your rights under this license. */
    ...
    function pidofFTL()
    {
        return shell_exec("pidof xfilter-FTL");
    }
    $FTLpid = intval(pidofFTL());
    $FTL = ($FTLpid !== 0 ? true : false);

    $xfilterFTLConfFile = "/etc/xfilter/xfilter-FTL.conf";
...
<head>
    ...
    <title>X-filter Admin Console</title>
    ...
    <link href="style/x-filter.css" rel="stylesheet" type="text/css" />
...
?>
<script src="scripts/x-filter/js/header.js"></script>
<!-- Send token to JS -->
...
<div class="wrapper">
    <header class="main-header">
        <!-- Logo -->
        <a href="http://x-filter.net" class="logo" target="_blank">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                            <img src="img/logo.svg" class="user-image" style="border-radius: initial" sizes="160x160" alt="X-filter logo" />
                            <span class="hidden-xs">X-filter</span>
                        </a>
                        <ul class="dropdown-menu" style="right:0">
                            ...
                            <li class="user-body">
                                <div class="col-xs-4 text-center">
                                    <a class="btn-link" href="https://github.com/x-filter" target="_blank">GitHub</a>
                                </div>
                                <div class="col-xs-4 text-center">
                                    <a class="btn-link" href="https://x-filter.net" target="_blank">Website</a>
                                </div>
                                <div class="col-xs-4 text-center">
                                    <a class="btn-link" href="https://github.com/x-filter/x-filter/releases" target="_blank">Updates</a>
                                </div>
                            ...
                            <li class="user-footer">
                                ...
                                <div class="<?php if(!isset($core_commit) && !isset($web_commit)) { ?>hidden-md <?php } ?>hidden-lg">
                                    <b>X-filter Version </b> <?php
                                    echo $core_current;
                                    if(isset($core_commit)) { echo "<br>(".$core_branch.", ".$core_commit.")"; }
                                    if($core_update){ ?> <a class="alert-link lookatme btn-link" href="https://github.com/x-filter/x-filter/releases" target="_blank" style="background:none">(Update available!)</a><?php } ?><br>
                                    <b>Web Interface Version </b><?php
                                    echo $web_current;
                                    if(isset($web_commit)) { echo "<br>(".$web_branch.", ".$web_commit.")"; }
                                    if($web_update){ ?> <a class="alert-link lookatme btn-link" href="https://github.com/x-filter/AdminLTE/releases" target="_blank" style="background:none">(Update available!)</a><?php } ?><br>
                                    <b>FTL Version </b> <?php
                                    echo $FTL_current;
                                    if($FTL_update){ ?> <a class="alert-link lookatme btn-link" href="https://github.com/x-filter/FTL/releases" target="_blank" style="background:none">(Update available!)</a><?php } ?><br><br>
                                </div>
                                */ ?>
                                <!-- PayPal -->
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="img/logo.svg" class="img-responsive" alt="X-filter logo" style="display: table; table-layout: fixed; height: 67px;" />
                </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li id="xfilter-disable" class="treeview"<?php if ($pistatus == "0") { ?> hidden="true"<?php } ?>>
                  <a href="#">
                    <span class="pull-right-container">
                      <i class="fa fa-angle-down pull-right" style="padding-right: 5px;"></i>
                    </span>
                  ...
                  <ul class="treeview-menu">
                    <li>
                        <a href="#" id="xfilter-disable-permanently">
                            <i class="fa fa-stop"></i> <span>Permanently</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" id="xfilter-disable-10s">
                            <i class="fa fa-clock-o"></i> <span>For 10 seconds</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" id="xfilter-disable-30s">
                            <i class="fa fa-clock-o"></i> <span>For 30 seconds</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" id="xfilter-disable-5m">
                            <i class="fa fa-clock-o"></i> <span>For 5 minutes</span>
                        </a>
                    </li>
                    <li>
                      <a href="#" id="xfilter-disable-cst" data-toggle="modal" data-target="#customDisableModal">
                ...
                <li id="xfilter-enable" class="treeview"<?php if ($pistatus == "1") { ?> hidden="true"<?php } ?>>
                ...
                <li class="treeview <?php if(in_array($scriptname, array("gravity.php", "queryads.php", "auditlog.php", "taillog.php", "taillog-FTL.php", "debug.php"))){ ?>active<?php } ?>">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li<?php if($scriptname === "taillog.php"){ ?> class="active"<?php } ?>>
                        <a href="taillog.php">
                            <i class="fa fa-list-ul"></i> <span>Tail xfilter.log</span>
                        </a>
                    </li>
                    <!-- Tail xfilter-FTL.log -->
                    <li<?php if($scriptname === "taillog-FTL.php"){ ?> class="active"<?php } ?>>
                        <a href="taillog-FTL.php">
                            <i class="fa fa-list-ul"></i> <span>Tail xfilter-FTL.log</span>
                        </a>
                    </li>
                    <!-- Generate debug log -->
...
<?php
    ...
    if(!$auth && (!isset($indexpage) || isset($_GET['login']))){
        require "scripts/x-filter/php/loginpage.php";
        require "footer.php";
        exit();
    }
?>
