...
$localversions = "/etc/xfilter/localversions";
$localbranches = "/etc/xfilter/localbranches";
$GitHubVersions = "/etc/xfilter/GitHubVersions";
...
else
{
	...
	/********** Get X-filter core branch / version / commit **********/
	...
	/********** Get X-filter web branch / version / commit **********/
	...
	/********** Get X-filter FTL (not a git repository) **********/
