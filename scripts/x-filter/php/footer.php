        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button  id="xfilter-disable-custom" type="button" class="btn btn-primary" data-dismiss="modal">Submit</button>
                </div>
            </div>
        </div>
    </div>
...
?>
	...
	<!-- Version Infos -->
        <div class="pull-right hidden-xs hidden-sm<?php if(isset($core_commit) || isset($web_commit) || isset($FTL_commit)) { ?> hidden-md<?php } ?>">
            ...
            if($core_update){ ?> <a class="alert-link lookatme" href="https://github.com/x-filter/x-filter/releases" target="_blank">(Update available!)</a><?php } ?>
            <b>Web Interface Version </b><?php
            echo $web_current;
            if(isset($web_commit)) { echo " (".$web_branch.", ".$web_commit.")"; }
            if($web_update){ ?> <a class="alert-link lookatme" href="https://github.com/x-filter/AdminLTE/releases" target="_blank">(Update available!)</a><?php } ?>
            <b>FTL Version </b> <?php
            echo $FTL_current;
            if(isset($FTL_commit)) { echo " (".$FTL_branch.", ".$FTL_commit.")"; }
            if($FTL_update){ ?> <a class="alert-link lookatme" href="https://github.com/x-filter/FTL/releases" target="_blank">(Update available!)</a><?php } ?>
        </div>
        <div style="display: inline-block"><strong><a href="https://x-filter.net/donate" target="_blank"><i class="fa fa-heart"></i> Donate</a></strong> if you found this useful.</div>
    </footer>
</div>
<!-- ./wrapper -->
...
<script src="scripts/x-filter/js/footer.js"></script>
