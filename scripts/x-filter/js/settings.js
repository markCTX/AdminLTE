...
$(".confirm-poweroff").confirm({
	text: "Are you sure you want to send a poweroff command to your X-Filter?",
...
$(".confirm-reboot").confirm({
	text: "Are you sure you want to send a reboot command to your X-Filter?",
	title: "Confirmation required",
	confirm(button) {
		$("#rebootform").submit();
	},
...
$(".confirm-disablelogging").confirm({
	text: "Are you sure you want to disable logging and flush your X-filter logs?",
	title: "Confirmation required",
	confirm(button) {
...
$(".api-token").confirm({
	...
	title: "Confirmation required",
	confirm(button) {
		window.open("scripts/x-filter/php/api_token.php");
	},
	cancel(button) {
		// nothing to do
	},
