...
function eventsource() {
    ...
    if (typeof EventSource !== "function") {
        httpGet(ta,"/admin/scripts/x-filter/php/debug.php?IE&token="+token+"&"+checked);
        return;
    }

    var host = window.location.host;
    var source = new EventSource("/admin/scripts/x-filter/php/debug.php?&token="+token+"&"+checked);
